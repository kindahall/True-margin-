...
namespace TrueMarginTrackerWordPress\Api;

use TrueMarginTrackerWordPress\Admin\SettingsPage;
use TrueMarginTrackerWordPress\Security\Signer;
...
final class Client
{
    ...
    {
        return $this->post('/stores/connect/wordpress', [
            'siteUrl' => home_url(),
            'name' => get_bloginfo('name'),
            'pluginVersion' => TMTWP_VERSION,
            'mode' => 'catalog',
